    ...
    if (product.images && product.images.length > 0) {
      ...
      allImages = product.images.map((img: any) => {
        ...
        if (img.url.startsWith('data:')) {
          ...
          img_url = `https://store25-0ven.onrender.com${img.url}`;
        } else {
      ...
      if (primaryImage.url.startsWith('data:')) {
        ...
        imageUrl = `https://store25-0ven.onrender.com${primaryImage.url}`;
      } else {
        imageUrl = primaryImage.url;
      }
      ...
      if (product.image.startsWith('data:')) {
        ...
        imageUrl = `https://store25-0ven.onrender.com${product.image}`;
      } else {
        imageUrl = product.image;
      }
